...
### **owl-sim**
A Python package for modelling and simulation of water and wastewater systems.
...
- If you have a model or tool that could be integrated into the OpenWaterLab ecosystem, feel free to contact the maintainers to discuss alignment and next steps.
...
- Feedback, suggestions, and design proposals
- New tools or models aligned with the mission of OpenWaterLab
...
If you are contributing code or models, please ensure compatibility with GPLv3 or discuss licensing considerations with the maintainers before submitting.
